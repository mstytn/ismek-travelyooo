...
// jshint -W033
    ...
    const countryElem = document.querySelector('.map-container h3');
    const nereye = document.querySelector('.nereye');
  function getACountry() {
    ...
    return countryList[Math.round(Math.random() * countryList.length)];
  }
  const transDur = 1500;
